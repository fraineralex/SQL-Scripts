...
-- MODIFICACI�N DE LA COLUMNA FIRST_NAME A 60 CARACTERES EN LA TABLA EMP2.
...
-- CONFIRMACI�N DE LAS TABLAS DEPT2 Y EMP2 EN EL DICCIONARIO

SELECT * FROM ALL_ALL_TABLES WHERE UPPER(TABLE_NAME) IN ('EMP2', 'DEPT2');

-- CREACI�N DE LA TABLA EMPLOYEES2
...
-- AGRAGDO DE LA RESTRICCI�N PRIMARY KEY A LA COLUMNA ID EN LA TABLA EMP2

ALTER TABLE EMP2
ADD CONSTRAINT my_emp_id_pk
PRIMARY KEY (ID);

-- AGREGADO DE LA RESTRICCI�N PRIMARY KEY A LA COLIMNA ID EN LA TABLA DEPT2.
...
-- CONFIRMACI�N DEL GUARDADO DE LAS RESTRICCIONES MEDIANTE LA VISTA USER CONSTRAINTS.
...
-- CREACI�N DE LA TABLA DEP_NAMED_INDEX.
...
/*1. Escriba una consulta para mostrar el apellido, el n�mero de departamento y el salario de cualquier empleado cuyo
n�mero de departamento y salario se correspondan con el n�mero de departamento y el salario de cualquier empleado
que gane una comisi�n. Use sub-consulta en pares*/
...
/* 2. Muestre el apellido, el nombre de departamento y el salario de cualquier empleado cuyo salario y comisi�n se
correspondan con el salario y la comisi�n de cualquier empleado con el identificador de ubicaci�n 1700. Use subconsulta en pares.*/
...
/* 4. Escriba una consulta para buscar todos los empleados que ganen m�s que el salario medio de su departamento.
...
--------------------------------------------------------------------------------------------------------------------------------
 ...
 /* 5. Escriba una consulta para mostrar los apellidos de los empleados que tienen uno o m�s colegas en su departamento
con fechas de contrataci�n posteriores pero salarios m�s altos. Use EXISTS. */
...
supere un octavo (1/8) del costo de salario total de toda la compa��a. Utilice la cl�usula WITH para escribir esta
