...
/*12. Seleccione todas las columnas de la tabla items_ordered, 
       en cuyas �rdenes se hayan comprado un "Tent".*/
...
/* 14. Seleccione los distintos items que se encuentren 
   ...
   de manera �nica los items que se encuentren en la tabla
                       items_ordered.*/
...
/* 15. Seleccione el precio m�ximo de cualquier 
...
/* 17. Cu�l es la cantidad total de 
...
/* 18. De todos los items "tents" que fueron ordenados en 
 la tabla items_ordered, cu�l es el de menor precio?*/
 ...
 /*19. Cu�ntas personas hay en cada estado, en la tabla de Clientes? 
...
/* 20. De la tabla items_ordered, seleccione el item, precio m�ximo 
             y m�nimo de cada item existente en la tabla. */
...
/* 21. Cu�ntas �rdenes hay por cliente? Use la tabla items_ordered. 
   Seleccione el Id del Cliente, cantidad de �rdenes realizadas 
                      y el precio total.*/
...
/* 22. Cu�ntas personas hay en cada estado en la tabla customers 
   que tengan dos o m�s personas en �l? Seleccione el estado y 
   despliegue la cantidad de personas, siempre y cuando hayan m�s de 1.*/
...
/* 23. De la tabla items_ordered, seleccione el item, y el precio m�ximo 
   y m�nimo de cada uno. Solamente despliegue los resultados de aquellos 
           items cuyo precio m�ximo sea mayor que 190. */
...
/* 24. Cu�ntas �rdenes ha realizado cada cliente? Use la tabla items_ordered. 
    Seleccione el ID del Cliente, cantidad de �rdenes realizadas por ellos
           y la sumatoria de precios, si hay m�s de 1 item comprado. */
...
/* 29. Seleccione la fecha, item y precio de la tabla items_ordered 
             cuyo precio est� entre 10.00 y 80.00.  */
...
/* 32. Escriba una consulta usando relaciones, para determinar cu�les items fueron 
...
/* 2.1 Construya un bloque PL/SQL que muestre la fecha de contrataci�n m�s 
reciente de un empleado. En pantalla debe desplegarse el siguiente mensaje:
         "La fecha m�s reciente es <fecha reciente>" */  
...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('La fecha m�s reciente es: ' ||FECHA_RCNT);
